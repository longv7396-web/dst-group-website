...
export const projects: Project[] = [
  ...
  },
  {
    ...
    sector: "Nhà hàng",
    category: "hospitality",
    summary: "DST đã thực hiện poster, nội dung social và mockup fanpage cho Nhà hàng Thiên Anh.",
    ...
    confidenceNote: "Chi tiết hạng mục theo tài liệu DST; liên hệ để tư vấn phạm vi phù hợp.",
  },
  {
    name: "Nhà hàng Thanh Thư",
    sector: "Nhà hàng",
    category: "hospitality",
    summary: "DST đã thực hiện poster, nội dung social và ảnh món cho Nhà hàng Thanh Thư.",
